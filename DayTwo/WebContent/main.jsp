...
<div class="Menu" id="left">
			...
			<br><br><div class="leftMenu" id="subMenu"> <a href="board.do?command=boardlist"> DayTwo 후기 </a>   <!-- 게시판 --></div>
			<br><br><div class="leftMenu" id="subMenu"> <a href=""> 내 캘린더 </a></div> <!-- 사용자 로그인시에만 보이게 -->
			<br><br><div class="leftMenu" id="subMenu"> <a href="'"> 회원 정보 수정 </a> <!-- 정보수정 --></div>
			<br><br><div class="leftMenu" id="subMenu"> <a href=""> 회원관리</a> <!-- 정보수정 --></div> <!-- 관리자로그인 시에만 보이게 -->
	<br><br><br><br><div class="leftMenu" id="subMenu"> <a href=""> ☞ 후원하기 </a></div><br> <!-- 결제api연결하기 -->
</div>
